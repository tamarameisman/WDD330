(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[7],{"97gy":function(e,r,a){"use strict"
...
var _=function(e){Object(i["a"])(a,e)
var r=Object(s["a"])(a)
function a(){Object(n["a"])(this,a)
return r.apply(this,arguments)}Object(o["a"])(a,[{key:"render",value:function(){return c.a.createElement(l["a"],Object.assign({},this.props,{name:"IconCheckMark",viewBox:"0 0 1920 1920"}),u)}}])
a.displayName="IconCheckMarkSolid"
return a}(d["Component"])
_.glyphName="check-mark"
_.variant="Solid"
_.propTypes=Object(t["a"])({},l["a"].propTypes)},HVsT:function(e,r,a){"use strict"
a.d(r,"a",(function(){return _}))
var t=a("VTBJ")
var n=a("1OyB")
var o=a("vuIU")
...
var r=Object(s["a"])(a)
function a(){Object(n["a"])(this,a)
return r.apply(this,arguments)}Object(o["a"])(a,[{key:"render",value:function(){return c.a.createElement(l["a"],Object.assign({},this.props,{name:"IconNo",viewBox:"0 0 1920 1920"}),u)}}])
a.displayName="IconNoSolid"
return a}(d["Component"])
_.glyphName="no"
_.variant="Solid"
_.propTypes=Object(t["a"])({},l["a"].propTypes)},"L+/K":function(e,r,a){"use strict"
...
t.state={open:true}
return t}Object(o["a"])(a,[{key:"variantUI",value:function(){return{error:{Icon:w["a"],className:E.error},info:{Icon:I,className:E.info},success:{Icon:M["a"],className:E.success},warning:{Icon:q["a"],className:E.warning}}[this.props.variant]}},{key:"clearTimeouts",value:function(){this._timeouts.forEach((function(e){return clearTimeout(e)}))
...
e.setAttribute("aria-atomic",this.props.isLiveRegionAtomic)}}},{key:"createScreenreaderContentNode",value:function(){return c.a.createElement(C["a"],null,this.props.children)}},{key:"createScreenreaderAlert",value:function(){var e=this.getLiveRegion()
...
r&&u.a.render(null,r,(function(){var a=e.createScreenreaderContentNode()
u.a.render(a,r)}))}}},{key:"removeScreenreaderAlert",value:function(){var e=this.getLiveRegion()
...
return c.a.createElement("div",{className:E.icon},c.a.createElement(r,{className:E.alertIcon}))}},{key:"renderCloseButton",value:function(){var e=this.props.renderCloseButtonLabel&&Object(k["a"])(this.props.renderCloseButtonLabel)||this.props.closeButtonLabel
return e?c.a.createElement("div",{className:E.closeButton,key:"closeButton"},c.a.createElement(f["a"],{onClick:this.close,size:"small",screenReaderLabel:e})):null}},{key:"renderAlert",value:function(){var e
var r=this.variantUI(),a=r.className
var n=m()((e={},Object(t["a"])(e,E.alert,true),Object(t["a"])(e,a,true),Object(t["a"])(e,E.hasShadow,this.props.hasShadow),e))
return c.a.createElement(y["a"],{as:"div",margin:this.props.margin,className:n,onKeyUp:this.handleKeyUp},this.renderIcon(),c.a.createElement("div",{className:E.content},this.props.children),this.renderCloseButton())}},{key:"render",value:function(){if(this.props.screenReaderOnly){this.getLiveRegion()
return null}if("none"===this.props.transition)return this.state.open?this.renderAlert():null
return c.a.createElement(L["a"],{type:this.props.transition,transitionOnMount:true,in:this.state.open,unmountOnExit:true,onExited:this.onExitTransition},this.renderAlert())}}])
a.displayName="Alert"
return a}(d["Component"]),N.propTypes={children:v.a.node,variant:v.a.oneOf(["info","success","warning","error"]),margin:S["c"].spacing,liveRegion:v.a.func,liveRegionPoliteness:v.a.oneOf(["polite","assertive"]),isLiveRegionAtomic:v.a.bool,screenReaderOnly:v.a.bool,timeout:v.a.number,renderCloseButtonLabel:v.a.oneOfType([v.a.func,v.a.node]),closeButtonLabel:v.a.string,onDismiss:v.a.func,transition:v.a.oneOf(["none","fade"]),open:v.a.bool,hasShadow:v.a.bool},N.defaultProps={variant:"info",margin:"x-small 0",timeout:0,transition:"fade",open:true,screenReaderOnly:false,liveRegionPoliteness:"assertive",isLiveRegionAtomic:false,onDismiss:void 0,liveRegion:void 0,renderCloseButtonLabel:void 0,closeButtonLabel:void 0,children:null,hasShadow:true},T))||z)||z)},uloQ:function(e,r,a){"use strict"
a.d(r,"a",(function(){return C}))
a.d(r,"b",(function(){return w}))
a.d(r,"c",(function(){return O}))
var t=a("An8g")
var n=a("q1tI")
var o=a.n(n)
a("17x9")
...
a=e.message}else if(e.response.data.message){r=e.response.data.message
a=e.message}}catch(a){r=e.message}return{a:r,b:a}}renderDetailMessage(){const e=this.findDetailMessage(),r=e.a,a=e.b
return Object(t["a"])(v["a"],{as:"p",fontStyle:"italic"},void 0,Object(t["a"])(v["a"],{},void 0,r),a?b||(b=Object(t["a"])("br",{})):null,a?Object(t["a"])(v["a"],{},void 0,a):null)}render(){let e=null
this.props.error&&(e=this.state.showDetails?this.renderDetailMessage():Object(t["a"])("span",{},void 0,Object(t["a"])(p["a"],{},void 0,Object(t["a"])(_["a"],{variant:"link",onClick:this.showDetails},void 0,l.t("Details"))),Object(t["a"])(m["a"],{},void 0,this.renderDetailMessage())))
...
function C({message:e,err:r,type:a=(r?"error":"info"),srOnly:n=false}){function o(e){s.a.unmountComponentAtNode(e)
...
document.body.appendChild(e)}return e}function d(i){s.a.render(Object(t["a"])(y,{message:e,timeout:Number.isNaN(parseInt(ENV.flashAlertTimeout,10))?f:ENV.flashAlertTimeout,error:r,variant:a,onClose:o.bind(null,i),screenReaderOnly:n}),i)}const c=document.createElement("div")
c.setAttribute("style","max-width:50em;margin:1rem auto;")
c.setAttribute("class","flashalert-message")
i().appendChild(c)
d(c)}function w(e=l.t("An error occurred making a network request")){return r=>C({message:e,err:r,type:"error"})}function O(e){return()=>C({message:e,type:"success"})}},znKQ:function(e,r,a){"use strict"
a.d(r,"a",(function(){return _}))
var t=a("VTBJ")
var n=a("1OyB")
var o=a("vuIU")
...
var r=Object(s["a"])(a)
function a(){Object(n["a"])(this,a)
return r.apply(this,arguments)}Object(o["a"])(a,[{key:"render",value:function(){return c.a.createElement(l["a"],Object.assign({},this.props,{name:"IconWarningBorderless",viewBox:"0 0 1920 1920"}),u)}}])
...
//# sourceMappingURL=7-c-739efb0876.js.map
(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[3675,4070],{"5nFh":function(e,t,a){"use strict"
...
return{expanded:!t}}
var f=function(e){Object(i["a"])(a,e)
var t=Object(r["a"])(a)
function a(e){var n
Object(s["a"])(this,a)
n=t.call(this)
...
return n}Object(d["a"])(a,[{key:"isControlled",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this.props
return"boolean"===typeof e.expanded}},{key:"render",value:function(){var e=this
var t=this.props,a=t.children,s=t.render,d=void 0===s?a:s
return"function"===typeof d?d({expanded:this.expanded,getToggleProps:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return Object(n["a"])({"aria-controls":e._contentId,"aria-expanded":e.expanded,onClick:Object(b["a"])(e.handleToggle,t.onClick)},t)},getDetailsProps:function(t){return{id:e._contentId}}}):null}},{key:"expanded",get:function(){return this.isControlled()?this.props.expanded:this.state.expanded}}],[{key:"getDerivedStateFromProps",value:function(e,t){return"boolean"===typeof e.expanded&&e.expanded!==t.expanded?{expanded:e.expanded}:null}}])
a.displayName="Expandable"
return a}(o["Component"])
f.propTypes={expanded:Object(l["a"])(c.a.bool,"onToggle","defaultExpanded"),defaultExpanded:c.a.bool,onToggle:c.a.func,children:c.a.func,render:c.a.func}
f.defaultProps={defaultExpanded:false,onToggle:function(e,t){},expanded:void 0,children:null,render:void 0}},"6dnZ":function(e,t,a){"use strict"
a.r(t)
var n=a("ANjH")
var s=a("An8g")
var d=a("q1tI")
...
const a=N()({"crs-student__trend-icon":true,"crs-student__trend-icon__positive":1===t,"crs-student__trend-icon__neutral":0===t,"crs-student__trend-icon__negative":-1===t})
const n=null!==t&&void 0!==t
return Object(s["a"])("div",{className:"crs-student-range__item"},void 0,Object(s["a"])("img",{src:e,className:"crs-student__avatar",onClick:this.selectStudent}),Object(s["a"])("button",{className:"crs-student__name crs-link-button",onClick:this.selectStudent,"aria-label":q.t("Select student %{name}",{name:this.props.student.user.name})},void 0,this.props.student.user.name),n&&Object(s["a"])("span",{className:a}))}}l.a.object,l.a.func
class H extends i.a.Component{render(){this.props.range.students
return Object(s["a"])("div",{className:"crs-student-range"},void 0,this.props.range.students.map((e,t)=>Object(s["a"])(F,{student:e,studentIndex:t,selectStudent:this.props.onStudentSelect},e.user.id)))}}l.a.array,l.a.func,l.a.object
class Q extends i.a.Component{constructor(e){super()
this.handleToggle=e=>{this.setState({selectedRange:e})}
this.state={selectedRange:e.selectedPath.range}}renderTabs(){return this.props.ranges.map((e,t)=>{const a=this.state.selectedRange===t
...
return Object(s["a"])("div",{className:"crs-student-details__assignment"},void 0,Object(s["a"])("i",{className:`icon-${n} crs-student-details__assignment-icon crs-icon-${n}`}),Object(s["a"])("div",{className:"crs-student-details__assignment-name"},void 0,this.props.assignment.name),Object(s["a"])("div",{className:"crs-student-details__assignment-score"},void 0,Object(s["a"])("div",{},void 0,Object(g["b"])(this.props.assignment.score,this.props.assignment,true)),a&&Object(s["a"])("span",{className:t})))}}var Y,X,ee,te
l.a.shape,l.a.string,l.a.number,l.a.arrayOf,l.a.func,l.a.bool
class ae extends i.a.Component{componentDidUpdate(e){this.props.student&&!e.student&&setTimeout(()=>this.backButton.focus(),100)}renderHeader(){if(!this.props.student)return null
return Object(s["a"])("header",{className:"crs-student-details__header"},void 0,i.a.createElement("button",{className:"crs-breakdown__link crs-back-button",ref:e=>{this.backButton=e},onClick:this.props.unselectStudent},Y||(Y=Object(s["a"])("i",{"aria-hidden":true,className:"icon-arrow-open-left"})),K.t("Back")))}renderStudentProfile(){const e=this.props,t=e.student,a=e.triggerAssignment
...
return Object(s["a"])("section",{className:"crs-student-details__profile-content"},void 0,Object(s["a"])("button",{className:"Button Button--icon-action student-details__prev-student","aria-label":K.t("view previous student"),onClick:this.props.selectPrevStudent,type:"button"},void 0,X||(X=Object(s["a"])("i",{"aria-hidden":true,className:"icon-arrow-open-left"}))),Object(s["a"])("div",{className:"crs-student-details__profile-inner-content"},void 0,Object(s["a"])("img",{src:d,"aria-hidden":true,className:"crs-student-details__profile-image"}),Object(s["a"])("h3",{className:"crs-student-details__name"},void 0,t.name),Object(s["a"])("a",{target:"_blank",rel:"noopener noreferrer",href:i,className:"crs-breakdown__link"},void 0,ee||(ee=Object(s["a"])("i",{"aria-hidden":true,className:"icon-email crs-icon-email"})),K.t("Send Message"))),Object(s["a"])("button",{className:"Button Button--icon-action student-details__next-student","aria-label":K.t("view next student"),onClick:this.props.selectNextStudent,type:"button"},void 0,te||(te=Object(s["a"])("i",{"aria-hidden":true,className:"icon-arrow-open-right"}))))}renderTriggerAssignment(){const e=this.props,t=e.student,a=e.triggerAssignment
const n=a||{},d=n.assignment,i=n.submission
...
return Object(s["a"])("section",{className:"crs-student-details__score-content"},void 0,Object(s["a"])("h3",{className:"crs-student-details__score-number"},void 0,Object(g["a"])(i.grade,d)),Object(s["a"])("div",{className:"crs-student-details__score-title"},void 0,d.name),o?Object(s["a"])("div",{className:"crs-student-details__score-date"},void 0,K.t("Submitted: %{submitDate}",{submitDate:o})):null,Object(s["a"])("a",{target:"_blank",rel:"noopener noreferrer",href:r,className:"crs-breakdown__link"},void 0,K.t("View Submission")))}renderFollowOnAssignments(){const e=this.props.followOnAssignments||[]
return Object(s["a"])("section",{},void 0,e.map((e,t)=>Object(s["a"])(Z,{assignment:e.assignment,score:e.score,trend:e.trend},t)))}renderContent(){if(this.props.isLoading)return Object(s["a"])("div",{className:"crs-student-details__loading"},void 0,Object(s["a"])(u["a"],{renderTitle:K.t("Loading"),size:"small"}),Object(s["a"])("p",{},void 0,K.t("Loading Data..")))
...
class ne extends i.a.Component{constructor(...e){super(...e)
...
const t=this.props.ranges[this.props.selectedPath.range]
e<t.size-1?e+=1:e=0
this.props.selectStudent(e)}}render(){const e=this.props,t=e.selectedPath,a=e.ranges,n=e.students
const d=null!==t.student?a[t.range].students[t.student].user:null
const r=null!==t.student&&d?n[d.id]:null
return Object(s["a"])(j["a"],{open:this.props.showDetails,placement:"end",shouldContainFocus:true,defaultFocusElement:()=>this.closeButton},void 0,Object(s["a"])("div",{className:"crs-breakdown-details"},void 0,Object(s["a"])("div",{className:"crs-breakdown-details__content"},void 0,Object(s["a"])("span",{className:"crs-breakdown-details__closeButton"},void 0,i.a.createElement(S["a"],{variant:"icon",ref:e=>{this.closeButton=e},onClick:this.props.closeSidebar},Object(s["a"])("span",{className:"crs-breakdown-details__closeButtonIcon"},void 0,Object(s["a"])(z["a"],{title:O.t("Close details sidebar")})))),Object(s["a"])(Q,{assignment:this.props.assignment,ranges:a,selectedPath:t,selectStudent:this.props.selectStudent,student:d}),Object(s["a"])(ae,{isLoading:this.props.isStudentDetailsLoading,student:d,triggerAssignment:r&&r.triggerAssignment,followOnAssignments:r&&r.followOnAssignments,selectPrevStudent:this.selectPrevStudent,selectNextStudent:this.selectNextStudent,unselectStudent:this.unselectStudent}))))}}const se=Object(_["b"])(e=>({assignment:e.assignment,ranges:e.ranges,enrolled:e.enrolled,isLoading:e.isInitialDataLoading}))(y)
const de=Object(_["b"])(e=>({isStudentDetailsLoading:e.isStudentDetailsLoading,selectedPath:e.selectedPath,assignment:e.assignment,ranges:e.ranges,students:e.studentCache,showDetails:e.showDetails}))(ne)
...
o.a.render(Object(s["a"])(_["a"],{store:this.store},void 0,i.a.createElement(se,t)),e)}renderDetails(e){const t={selectRange:this.actions.selectRange,selectStudent:this.actions.selectStudent,closeSidebar:this.actions.closeSidebar}
o.a.render(Object(s["a"])(_["a"],{store:this.store},void 0,i.a.createElement(de,t)),e)}}var re=a("sINF")
var oe=a("VTBJ")
var _e=a("Y/W1")
var ce=a.n(_e)
const le=(e,t)=>(a,n)=>{a=void 0===a?t:a
if(e[n.type]){let t=a
ce.a.isObject(a)?t=Object(oe["a"])({},a):Array.isArray(a)&&(t=a.slice())
return e[n.type](t,n)}return a}
const ue=(e,t)=>t.payload
const be=(e="")=>(t,a)=>void 0===t?e:t
var pe=a("BrAc")
const fe={call:({apiUrl:e,jwt:t},a)=>Object(pe["a"])({url:e+a,dataType:"json",headers:{Authorization:"Bearer "+t}}).then(e=>e.data),loadInitialData(e){const t="/students_per_range?trigger_assignment="+e.assignment.id
return fe.call(e,t)},loadStudent(e,t){const a=`/student_details?trigger_assignment=${e.assignment.id}&student_id=${t}`
return fe.call(e,a)}}
var ge=fe
function me(e){const t=e.split("_")
return t.map((e,t)=>0!==t&&e.length?e.charAt(0).toUpperCase()+e.slice(1).toLowerCase():e.toLowerCase()).join("")}function ve(e){const t=t=>({type:e,payload:t})
t.type=e
t.toString=()=>e
return t}function he(e){const t={}
const a={}
e.forEach(e=>{const n=ve(e)
const s=me(n.type)
a[s]=n
t[n.type]=n.type})
return{actionTypes:t,actions:a}}const we=["SET_INITIAL_DATA","SET_SCORING_RANGES","SET_RULE","SET_ENROLLED","SET_ASSIGNMENT","SET_ERRORS","SET_STUDENT_DETAILS","SELECT_RANGE","ADD_STUDENT_TO_CACHE","SELECT_STUDENT","OPEN_SIDEBAR","CLOSE_SIDEBAR","LOAD_INITIAL_DATA_START","LOAD_INITIAL_DATA_END","LOAD_STUDENT_DETAILS_START","LOAD_STUDENT_DETAILS_END"]
const ke=he(we),ye=ke.actions,Se=ke.actionTypes
ye.closeSidebarFrd=ye.closeSidebar
ye.closeSidebar=()=>(e,t)=>{const a=t().sidebarTrigger
e(ye.closeSidebarFrd())
a.focus()}
ye.loadInitialData=e=>(e,t)=>{e(ye.loadInitialDataStart())
ge.loadInitialData(t()).then(t=>{e(ye.setInitialData(t))
e(ye.loadInitialDataEnd())}).catch(t=>{e(ye.setErrors(t))
e(ye.loadInitialDataEnd())})}
ye.loadStudent=e=>(t,a)=>{t(ye.loadStudentDetailsStart())
ge.loadStudent(a(),e).then(a=>{t(ye.addStudentToCache({studentId:e,data:a}))
t(ye.loadStudentDetailsEnd())}).catch(e=>{t(ye.loadStudentDetailsEnd())
t(ye.setErrors(e))})}
ye.selectStudent=e=>(t,a)=>{t({type:Se.SELECT_STUDENT,payload:e})
const n=a(),s=n.studentCache,d=n.ranges,i=n.selectedPath
const r=d[i.range].students[e]
r&&!s[r.user.id.toString()]&&t(ye.loadStudent(r.user.id.toString()))}
const je=le({[Se.ADD_STUDENT_TO_CACHE]:(e,t)=>{const a=t.payload,n=a.studentId,s=a.data
e[n]={followOnAssignments:s.follow_on_assignments,triggerAssignment:s.trigger_assignment}
return e}},{})
const ze=le({[Se.LOAD_INITIAL_DATA_START]:()=>true,[Se.LOAD_INITIAL_DATA_END]:()=>false},false)
const Oe=le({[Se.LOAD_STUDENT_DETAILS_START]:()=>true,[Se.LOAD_STUDENT_DETAILS_END]:()=>false},false)
const Ee=le({[Se.SET_ERRORS]:(e,t)=>[...Array.from(t.payload),...Array.from(e)]},[])
const De=le({[Se.SET_INITIAL_DATA]:(e,t)=>t.payload.ranges,[Se.SET_SCORING_RANGES]:ue},[])
const Be=le({[Se.SET_ASSIGNMENT]:ue},{})
const xe=le({[Se.SET_INITIAL_DATA]:(e,t)=>t.payload.rule,[Se.SET_RULE]:ue},{course_id:"",trigger_assignment:""})
const Ae=le({[Se.SET_INITIAL_DATA]:(e,t)=>t.payload.enrolled,[Se.SET_ENROLLED]:ue},0)
const Ne=le({[Se.OPEN_SIDEBAR]:(e,t)=>t.payload,[Se.CLOSE_SIDEBAR]:()=>null},null)
const Te=le({[Se.OPEN_SIDEBAR]:()=>true,[Se.CLOSE_SIDEBAR]:()=>false,[Se.SELECT_RANGE]:(e,t)=>null!==t.payload},false)
const Ce=le({[Se.SELECT_RANGE]:(e,t)=>{e.range=t.payload
...
var Ie=Object(n["combineReducers"])({apiUrl:be(),jwt:be(),studentCache:je,isInitialDataLoading:ze,isStudentDetailsLoading:Oe,errors:Ee,ranges:De,assignment:Be,rule:xe,enrolled:Ae,sidebarTrigger:Ne,showDetails:Te,selectedPath:Ce})
const Me=Object(n["applyMiddleware"])(re["a"])(n["createStore"])
function Le(e){return Me(Ie,e)}var Pe=Le
const Je={init:(e,t)=>{const a=window.ENV
if(null!=e&&a.CONDITIONAL_RELEASE_SERVICE_ENABLED&&null!=a.CONDITIONAL_RELEASE_ENV.rule){const s=a.CONDITIONAL_RELEASE_ENV,d=s.assignment,i=s.stats_url
...
c.loadInitialData()
return l}}}
t["default"]=Je},CyXg:function(e,t,a){"use strict"
...
var t=Object(r["a"])(a)
function a(){Object(s["a"])(this,a)
return t.apply(this,arguments)}Object(d["a"])(a,[{key:"render",value:function(){return _.a.createElement(c["a"],Object.assign({},this.props,{name:"IconMiniArrowEnd",viewBox:"0 0 1920 1920",bidirectional:true}),l)}}])
a.displayName="IconMiniArrowEndSolid"
return a}(o["Component"])
u.glyphName="mini-arrow-end"
u.variant="Solid"
u.propTypes=Object(n["a"])({},c["a"].propTypes)},KIj7:function(e,t,a){"use strict"
...
return e}Object(i["a"])(a,[{key:"focus",value:function(){this._button.focus()}},{key:"componentDidMount",value:function(){this.shouldAnimateContent=true}},{key:"renderSummary",value:function(e){var t=this.props,a=t.summary,n=t.iconPosition
return c.a.createElement("span",{className:x.summary},"start"===n&&this.renderIcon(e),c.a.createElement("span",{className:x.summaryText},a),"end"===n&&this.renderIcon(e))}},{key:"renderToggle",value:function(e,t){var d=this.props,i=d.variant,r=d.fluidWidth
var o=Object(s["a"])({},Object(k["a"])(this.props,a.propTypes),{},e,{children:this.renderSummary()})
var _=this.renderSummary(t)
return"filled"===i?c.a.createElement(f["a"],Object.assign({},o,{display:"block",textAlign:"start",elementRef:this.getButtonRef}),_):o.href?c.a.createElement("a",Object.assign({},o,{className:p()(x.toggle,x[i],Object(n["a"])({},x.fluidWidth,r)),ref:this.getButtonRef}),_):c.a.createElement("button",Object.assign({},o,{type:"button",className:p()(x.toggle,x[i],Object(n["a"])({},x.fluidWidth,r)),ref:this.getButtonRef}),_)}},{key:"renderIcon",value:function(e){var t
var a=this.props.iconPosition
var s=e?this.props.iconExpanded:this.props.icon
return this.props.children?c.a.createElement("span",{className:p()(x.icon,(t={},Object(n["a"])(t,x.iconStart,"start"===a),Object(n["a"])(t,x.iconEnd,"end"===a),t))},c.a.createElement(s,null)):null}},{key:"renderDetails",value:function(e,t){var a
var s=this.props,d=s.children,i=s.size,r=s.iconPosition,o=s.fluidWidth
return c.a.createElement("div",Object.assign({},t,{className:p()(x.details,(a={},Object(n["a"])(a,x[i],i),Object(n["a"])(a,x.hiddenDetails,!e),Object(n["a"])(a,x.expandedDetails,e),Object(n["a"])(a,x.indentDetails,"start"===r&&!o),a))}),d&&e&&this.renderContent())}},{key:"renderContent",value:function(){return c.a.createElement("div",{className:p()(Object(n["a"])({},x.content,this.shouldAnimateContent))},this.props.children)}},{key:"render",value:function(){var e,t=this
var a=this.props,s=a.variant,d=a.iconPosition,i=a.fluidWidth
var r="end"===d&&("filled"===s||i)
var o=(e={},Object(n["a"])(e,x.root,true),Object(n["a"])(e,x[this.props.size],true),Object(n["a"])(e,x.positionIconAtEnd,r),e)
return c.a.createElement(v["a"],Object(k["c"])(this.props,v["a"].propTypes),(function(e){var a=e.expanded,n=e.getToggleProps,s=e.getDetailsProps
return c.a.createElement("div",{className:p()(o)},t.renderToggle(n(),a),t.renderDetails(a,s()))}))}},{key:"focused",get:function(){return Object(y["a"])(this._button)}}])
a.displayName="ToggleDetails"
return a}(_["Component"]),D.propTypes={variant:u.a.oneOf(["default","filled"]),summary:u.a.node.isRequired,expanded:Object(w["a"])(u.a.bool,"onToggle","defaultExpanded"),defaultExpanded:u.a.bool,onToggle:u.a.func,icon:u.a.func,iconExpanded:u.a.func,iconPosition:u.a.oneOf(["start","end"]),fluidWidth:u.a.bool,children:u.a.node,size:u.a.oneOf(["small","medium","large"])},D.defaultProps={variant:"default",size:"medium",fluidWidth:false,icon:g["a"],iconExpanded:m["a"],iconPosition:"start",defaultExpanded:false,onToggle:function(e,t){},children:null,expanded:void 0},B))||E)||E)},QJn8:function(e,t,a){"use strict"
a.d(t,"a",(function(){return d}))
var n=a("ouhR")
var s=a.n(n)
a("XbwQ")
function d(){return s()(".vdd_tooltip_link").tooltip({position:{my:"center bottom",at:"center top-10",collision:"fit fit"},tooltipClass:"center bottom vertical",content(){const e=s()(this).data("tooltipSelector")
try{const t=document.querySelector(e)
return s()(t).html()}catch(e){}}})}},QLaP:function(e,t,a){"use strict"
var n=function(e,t,a,n,s,d,i,r){false
if(!e){var o
...
else{var _=[a,n,s,d,i,r]
var c=0
o=new Error(t.replace(/%s/g,(function(){return _[c++]})))
o.name="Invariant Violation"}o.framesToPop=1
throw o}}
e.exports=n},UWEG:function(e,t,a){"use strict"
var n=a("ouhR")
var s=a.n(n)
a("dhbk")
...
return t}
const b=(e,t)=>{const a=u(t)
return a===r.points.key?g(e,t):a===r.letter_grade.key||a===r.gpa_scale.key?m(e,t):v(e)}
const p=(e,t,a)=>{e||(e=a?"1":"0")
return f(b(e,t),t)}
const f=(e,t)=>{const a=u(t)
return a===r.points.key?o.t("%{score} pts",{score:o.n(e,{precision:2,strip_insignificant_zeros:true})}):a===r.letter_grade.key||a===r.gpa_scale.key?e:o.n(e,{precision:2,percentage:true,strip_insignificant_zeros:true})}
const g=(e,t)=>{if(!c(e))return e
if(0===e)return"0"
const a=_["a"].parse(e)
...
for(const e in t.grading_scheme){const s=_["a"].parse(t.grading_scheme[e])
if(s<=a&&s>n.score||0===s&&s>a){n.score=s
n.letter=e}}return n.letter?n.letter:a}
const v=e=>{if(!c(e))return e
return Math.floor(100*e)}
const h=(e,t)=>{if("string"===typeof e&&t.grading_type!==r.letter_grade.key&&t.grading_type!==r.gpa_scale.key){const a=_["a"].parse(e.replace(/%$/,""))
if(!isNaN(a))return f(a,t)}return e}},dI71:function(e,t,a){"use strict"
a.d(t,"a",(function(){return s}))
var n=a("s4An")
function s(e,t){e.prototype=Object.create(t.prototype)
e.prototype.constructor=e
Object(n["a"])(e,t)}},jbBh:function(e,t,a){"use strict"
...
function r({submissions_zip:e}){if(!e)return false
if(!e.match(/\.zip$/)){s()(this).formErrors({submissions_zip:d["a"].t("Please upload files as a .zip")})
return false}const t=this.find('button[type="submit"]')
t.attr("disabled",true)
t.text(d["a"].t("Uploading..."))
return true}function o(e){const t=s()("#"+i)
t.find('input[name="submissions_zip"]').remove()
t.removeAttr("enctype")
t.append(`<input type="hidden" name="attachment_id" value="${e.id}">`)
document.getElementById(i).submit()}function _(e){const t=this.find('button[type="submit"]')
t.attr("disabled",false)
t.text(d["a"].t("Upload Files"))
return this}function c(e){return{errorMessage:d["a"].t("Upload error. Please try again.")}}function l(e){const t={fileUpload:true,fileUploadOptions:{context_code:e,formDataTarget:"uploadDataUrl",intent:"submissions_zip_upload",preparedFileUpload:true,singleFile:true,upload_only:true,preferFileValueForInputName:false},object_name:"attachment",beforeSubmit:r,error:_,errorFormatter:c,success:o}
s()("#"+i).formSubmit(t)
return t}},"rf+m":function(e,t,a){"use strict"
a.d(t,"a",(function(){return u}))
var n=a("VTBJ")
var s=a("1OyB")
var d=a("vuIU")
...
var f=a("mX+G")
var g=a.n(f)
var m=function(e,t){return function(){return e.apply(t,arguments)}},v=function(e,t){for(var a in t)h.call(t,a)&&(e[a]=t[a])
function n(){this.constructor=e}n.prototype=t.prototype
e.prototype=new n
e.__super__=t.prototype
return e},h={}.hasOwnProperty
var w=function(e){v(t,e)
...
var A=a("3lLS")
var N=a.n(A)
N()(()=>{const e=new j["default"]
e.init({itemType:"assignment",page:"show"})})
let T=[]
function C(e){if("0"!==e){const t={selectedStudentGroupId:e}
T.push(t)
ENV.selected_student_group_id=e
M()
I()
c["a"].put(`/api/v1/courses/${ENV.COURSE_ID}/gradebook_settings`,u.a.stringify({gradebook_settings:{filter_rows_by:{student_group_id:e}}})).finally(()=>{T=T.filter(e=>e!==t)
I()})}}function I(){const e=ENV.SETTINGS.filter_speed_grader_by_student_group&&(!ENV.selected_student_group_id||T.length>0)
const t=document.getElementById("speed_grader_link_mount_point")
t&&_.a.render(Object(n["a"])(E["a"],{disabled:e,href:ENV.speed_grader_url,disabledTip:d["a"].t("Must select a student group first")}),t)}function M(){const e=document.getElementById("student_group_filter_mount_point")
e&&_.a.render(Object(n["a"])(O["a"],{categories:ENV.group_categories,label:d["a"].t("Select Group to Grade"),onChange:C,value:ENV.selected_student_group_id}),e)}N()(()=>{const e=document.getElementById("immersive_reader_mount_point")
const t=document.getElementById("immersive_reader_mobile_mount_point");(e||t)&&a.e(162).then(a.bind(null,"AZYJ")).then(a=>{var n
const s=()=>{var e
return null===(e=document.querySelector(".description"))||void 0===e?void 0:e.innerHTML}
const d=null===(n=document.querySelector(".title"))||void 0===n?void 0:n.textContent
e&&a.initializeReaderButton(e,{content:s,title:d})
t&&a.initializeReaderButton(t,{content:s,title:d})}).catch(e=>{console.log("Error loading immersive readers.",e)})})
const L=Promise.all([a.e(9),a.e(70),a.e(3631)]).then(a.bind(null,"fY8A"))
r()(()=>{const e=r()("#assignment_publish_button")
if(e.length>0){const t=new b["a"]({id:e.attr("data-id"),unpublishable:!e.hasClass("disabled"),published:e.hasClass("published")})
t.doNotParse()
new w({model:t,el:"#assignment-speedgrader-link"}).render()
const a=new p["a"]({model:t,el:e})
a.render()
a.on("publish",()=>r()("#moderated_grading_button").show())
a.on("unpublish",()=>r()("#moderated_grading_button").hide())}L.then(()=>{r()("#sequence_footer").moduleSequenceFooter({courseID:ENV.COURSE_ID,assetType:"Assignment",assetID:ENV.ASSIGNMENT_ID,location:window.location})})
return Object(k["a"])()})
r()(()=>r()("#content").on("click","#mark-as-done-checkbox",(function(){return y["a"].toggle(this)})))
function P(e,t=true){e&&e.preventDefault()
_.a.render(Object(n["a"])(D["a"],{open:t,sourceCourseId:ENV.COURSE_ID,contentShare:{content_type:"assignment",content_id:ENV.ASSIGNMENT_ID},onDismiss:()=>{P(null,false)
r()(".al-trigger").focus()}}),document.getElementById("direct-share-mount-point"))}function J(e,t=true){e&&e.preventDefault()
_.a.render(Object(n["a"])(B["a"],{open:t,sourceCourseId:ENV.COURSE_ID,contentSelection:{assignments:[ENV.ASSIGNMENT_ID]},onDismiss:()=>{J(null,false)
r()(".al-trigger").focus()}}),document.getElementById("direct-share-mount-point"))}r()(()=>{r()(".direct-share-send-to-menu-item").click(P)
r()(".direct-share-copy-to-menu-item").click(J)})
r()(()=>{if(ENV.speed_grader_url){ENV.SETTINGS.filter_speed_grader_by_student_group&&M()
I()}})
r()(()=>{r()(".upload_submissions_link").click(e=>{e.preventDefault()
r()("#re_upload_submissions_form").slideToggle()})
r()(".download_submissions_link").click((function(e){e.preventDefault()
s["a"].downloadSubmissions(r()(this).attr("href"))
r()(".upload_submissions_link").slideDown()}))
Object(x["a"])(ENV.USER_ASSET_STRING)
r()("#edit_assignment_form").bind("assignment_updated",(e,t)=>{t.assignment&&t.assignment.peer_reviews?r()(".assignment_peer_reviews_link").slideDown():r()(".assignment_peer_reviews_link").slideUp()})})
r()(()=>{const e=document.getElementById("crs-graphs")
const t=document.getElementById("not_right_side")
S["default"].init(e,t)
document.getElementById("assignment_external_tools")&&z["a"].attach(document.getElementById("assignment_external_tools"),"assignment_view",parseInt(ENV.COURSE_ID,10),parseInt(ENV.ASSIGNMENT_ID,10))})
N()(()=>{r()("#accessibility_warning").on("focus",(function(){r()("#accessibility_warning").removeClass("screenreader-only")}))
r()("#accessibility_warning").on("blur",(function(){r()("#accessibility_warning").addClass("screenreader-only")}))})},y2yB:function(e,t,a){"use strict"
a.d(t,"a",(function(){return u}))
var n=a("VTBJ")
var s=a("1OyB")
var d=a("vuIU")
...
var _=a.n(o)
var c=a("hPGw")
var l=_.a.createElement("path",{d:"M568.129648 0.0124561278L392 176.142104 1175.86412 960.130789 392 1743.87035 568.129648 1920 1528.24798 960.130789z",fillRule:"evenodd",stroke:"none",strokeWidth:"1",transform:"matrix(0 1 1 0 .067 -.067)"})
var u=function(e){Object(i["a"])(a,e)
var t=Object(r["a"])(a)
function a(){Object(s["a"])(this,a)
return t.apply(this,arguments)}Object(d["a"])(a,[{key:"render",value:function(){return _.a.createElement(c["a"],Object.assign({},this.props,{name:"IconArrowOpenDown",viewBox:"0 0 1920 1920"}),l)}}])
...
//# sourceMappingURL=assignment_show-c-9c1173e381.js.map
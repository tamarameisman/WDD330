(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[48],{"+XDm":function(e,t,i){var a=i("JPst")
var o=i("HeW1")
var n=i("uCtj")
var r=i("ldnB")
var s=i("md8m")
...
function _(e,t){const i=e.filter(t).first()
const a=e.index(i)
return a<0?0:a}function h(e,t,i,a){this.player=t
this.media=i
this.event=a
...
this.isFirefox=e.MediaFeatures.isFirefox}h.keyCodes=p
h.prototype._targetControl=function(e){return m()(this.event.target).closest(e)}
h.prototype.handlerKey=function(){const e=Object.keys(f).find(e=>this._targetControl(f[e]).length)
return e||"player"}
...
const o=_(a,(e,i)=>"none"===i.value&&null==t.selectedTrack||t.selectedTrack&&i.value===t.selectedTrack.srclang)
...
h.prototype.fullscreenHandler=function(){const e=this.player,t=this.event
...
h.prototype.playpauseHandler=function(){const e=this.player,t=this.media
let i
...
const a=_(i,(e,i)=>i.value===t.media.src)
...
const a=_(i,(e,i)=>parseFloat(i.value)===t.media.playbackRate)
switch(this.keyCode){case p.DOWN:e=Math.min(a+1,i.length-1)
i.slice(e).first().focus().click()
break
case p.UP:e=Math.max(a-1,0)
i.slice(e).first().focus().click()}}
h.prototype.volumeHandler=function(){const e=this.player,t=this.media
let i
switch(this.keyCode){case p.SPACE:if(this.isFirefox)break
...
t.setVolume(i)}}
h.prototype.playerHandler=function(){const e=this.player,t=this.media,i=this.event
let a
let o
...
u["a"].MepDefaults.success=function(e,t){i.e(4203).then(i.bind(null,"eTZi")).then(({default:t})=>{t(this.mediaCommentId,e,INST.kalturaSettings)})
return e.play()}
...
function s(){const e=m.a.extend({mode:"auto"},u["a"].MediaElementDefaults,u["a"].MepDefaults,o)
...
o.mode="auto_plugin"
o.isVideo=false
o.videoHeight=i=30}return y.getElement(n,r,a,i)}const S={create(e,t,i,a){m()("#media_recorder_container").removeAttr("id")
...
return m.a.mediaComment.init(e,o)},show_inline(e,t="video",i){const a=m()(this).closest(".instructure_file_link_holder").andSelf().first()
...
return m.a.ajaxJSON(e,"GET",{},r,t)}return o(e,a)},show(e,t="video",i=null){m()(".play_media_comment").find(".ui-dialog-titlebar-close").click()
const a=m()(this)
...
let a=i.offset(),n=i.outerWidth(),r=i.outerHeight(),s=a.top,l=s+r,d=a.left,u=d+n,c="html,body"==this.selector?o.a.windowScrollTop():this.scrollTop(),m=this.scrollLeft(),p=this.outerHeight(),f=this.outerWidth()
...
function _(e,t){const i=c.a.mediaComment.contextCode()
...
d.a.publish("media_comment_created",{id:e.entryId,mediaType:a,title:e.userTitle})}const h={}
c.a.mediaComment.entryAdded=function(e,t,i,a){if(!e||h[e])return
h[e]=true
...
let g=false
let b=null
c.a.mediaComment.init=function(e,t){Promise.all([i.e(9),i.e(25),i.e(33),i.e(3798)]).then((()=>{const a=i("ufgb")
b=b||new Date
e=e||"any"
t=t||{}
...
let x,T
g=true
setInterval(()=>{if(g){_=c()("#audio_record_holder")
h=c()("#audio_record")
...
if(e>-1&&!_.hasClass("with_volume")){b.css("display","none")
...
const n=o();("Chrome"===n.name&&Number(n.version)>=68||"Firefox"===n.name&&Number(n.version)>=61)&&Promise.all([i.e(1),i.e(2),i.e(3),i.e(5),i.e(14),i.e(18),i.e(116),i.e(4071)]).then(i.bind(null,"2Ema")).then(({default:e})=>{let t
...
window.mediaCommentCallback=function(e){s.a.each(e,_)
...
o.setVolume(t)},_=false,h=false
l.hover((function(){d.removeClass("mejs-offscreen")
h=true}),(function(){h=false
...
t.length||h||"vertical"!=s||d.addClass("mejs-offscreen")}),0)}),100)
d.bind("mouseover",(function(){h=true})).bind("mousedown",(function(e){f(e)
r.globalBind("mousemove.vol",(function(e){f(e)}))
r.globalBind("mouseup.vol",(function(){_=false
r.globalUnbind(".vol")
...
o.addEventListener("volumechange",(function(e){if(!_)if(o.muted){p(0)
...
a.length<r&&(s=a[r])
var p=false
for(var f=0,_=m.length;f<_;f++)if(-1!==a.indexOf(m[f][1]))p=true
else if(p){var h=false
for(var g=f;g<_;g++)if(m[g][0]>0){h=true
break}if(!h)break
n||(a=o+a)
a=m[f][1]+s+a
n&&(a=m[f][1]+a)
...
return this},determinePlayback:function(e,t,i,o,n){var r,s,l,d,u,c,m,p,f,_,h,g=[],b={method:"",url:"",htmlMediaElement:e,isVideo:"audio"!==e.tagName.toLowerCase(),scheme:""}
...
g.push({type:c,url:n})}else for(r=0;r<e.childNodes.length;r++){u=e.childNodes[r]
if(1==u.nodeType&&"source"==u.tagName.toLowerCase()){n=u.getAttribute("src")
c=this.formatType(n,u.getAttribute("type"))
h=u.getAttribute("media");(!h||!window.matchMedia||window.matchMedia&&window.matchMedia(h).matches)&&g.push({type:c,url:n})}}!o&&g.length>0&&null!==g[0].url&&this.getTypeFromFile(g[0].url).indexOf("audio")>-1&&(b.isVideo=false)
...
if(i&&("auto"===t.mode||"auto_plugin"===t.mode||"native"===t.mode)&&!(a.MediaFeatures.isBustedNativeHTTPS&&true===t.httpsBasicAuthSite)){if(!o){_=document.createElement(b.isVideo?"video":"audio")
e.parentNode.insertBefore(_,e)
e.style.display="none"
b.htmlMediaElement=e=_}for(r=0;r<g.length;r++)if("video/m3u8"==g[r].type||""!==e.canPlayType(g[r].type).replace(/no/,"")||""!==e.canPlayType(g[r].type.replace(/mp3/,"mpeg")).replace(/no/,"")||""!==e.canPlayType(g[r].type.replace(/m4a/,"mp4")).replace(/no/,"")){b.method="native"
b.url=g[r].url
...
t.error(o)},createPlugin:function(e,t,i,o,n,r){var s,l,d,u=e.htmlMediaElement,c=1,m=1,p="me_"+e.method+"_"+a.meIndex++,f=new a.PluginMediaElement(p,e.method,e.url),_=document.createElement("div")
f.tagName=u.tagName
for(var h=0;h<u.attributes.length;h++){var g=u.attributes[h]
...
_.className="me-plugin"
_.id=p+"_container"
e.isVideo?u.parentNode.insertBefore(_,u):document.body.insertBefore(_,document.body.childNodes[0])
if("flash"===e.method||"silverlight"===e.method){var b="audio/mp4"===u.getAttribute("type"),v=u.getElementsByTagName("source")
if(v&&!b){h=0
for(var y=v.length;h<y;h++)"audio/mp4"===v[h].getAttribute("type")&&(b=true)}d=["id="+p,"isvideo="+(e.isVideo||b?"true":"false"),"autoplay="+(o?"true":"false"),"preload="+n,"width="+c,"startvolume="+t.startVolume,"timerrate="+t.timerRate,"flashstreamer="+t.flashStreamer,"height="+m,"pseudostreamstart="+t.pseudoStreamingStartQueryParam]
...
j&&(k=j[1])}youtubeSettings={container:_,containerId:_.id,pluginMediaElement:f,pluginId:p,videoId:k,height:m,width:c,scheme:e.scheme,playerVars:t.youtubePlayerVars}
...
_.innerHTML='<iframe src="'+e.scheme+"player.vimeo.com/video/"+f.vimeoid+"?api=1&portrait=0&byline=0&title=0&player_id="+w+'" width="'+c+'" height="'+m+'" frameborder="0" class="mejs-shim" id="'+w+'" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'
if("function"==typeof $f){var x=$f(_.childNodes[0]),T=-1
...
void 0===e.en&&(e.en={"mejs.plural-form":1,"mejs.download-file":"Download File","mejs.fullscreen-off":"Turn off Fullscreen","mejs.fullscreen-on":"Go Fullscreen","mejs.download-video":"Download Video","mejs.fullscreen":"Fullscreen","mejs.time-jump-forward":["Jump forward 1 second","Jump forward %1 seconds"],"mejs.play":"Play","mejs.pause":"Pause","mejs.close":"Close","mejs.time-slider":"Time Slider","mejs.time-help-text":"Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.","mejs.time-skip-back":["Skip back 1 second","Skip back %1 seconds"],"mejs.captions-subtitles":"Captions/Subtitles","mejs.none":"None","mejs.mute-toggle":"Mute Toggle","mejs.volume-help-text":"Use Up/Down Arrow keys to increase or decrease volume.","mejs.unmute":"Unmute","mejs.mute":"Mute","mejs.volume-slider":"Volume Slider","mejs.video-player":"Video Player","mejs.audio-player":"Audio Player","mejs.ad-skip":"Skip ad","mejs.ad-skip-info":["Skip in 1 second","Skip in %1 seconds"],"mejs.source-chooser":"Source Chooser"})})(a.i18n.locale.strings)},O3h1:function(e,t,i){var a={"./me-i18n-locale-cs":["Zjte",3634],"./me-i18n-locale-cs.js":["Zjte",3634],"./me-i18n-locale-de":["C7He",3635],"./me-i18n-locale-de.js":["C7He",3635],"./me-i18n-locale-en":["tYpR",3636],"./me-i18n-locale-en.js":["tYpR",3636],"./me-i18n-locale-es":["KY2I",3637],"./me-i18n-locale-es.js":["KY2I",3637],"./me-i18n-locale-fr":["HiGp",3638],"./me-i18n-locale-fr.js":["HiGp",3638],"./me-i18n-locale-hu":["/Xzx",3639],"./me-i18n-locale-hu.js":["/Xzx",3639],"./me-i18n-locale-it":["bsL9",3640],"./me-i18n-locale-it.js":["bsL9",3640],"./me-i18n-locale-ja":["aVOL",3641],"./me-i18n-locale-ja.js":["aVOL",3641],"./me-i18n-locale-ko":["xv0d",3642],"./me-i18n-locale-ko.js":["xv0d",3642],"./me-i18n-locale-nl":["GE+S",3643],"./me-i18n-locale-nl.js":["GE+S",3643],"./me-i18n-locale-pl":["x7au",3644],"./me-i18n-locale-pl.js":["x7au",3644],"./me-i18n-locale-pt":["on1a",3646],"./me-i18n-locale-pt-br":["OMPk",3645],"./me-i18n-locale-pt-br.js":["OMPk",3645],"./me-i18n-locale-pt.js":["on1a",3646],"./me-i18n-locale-ro":["Wvze",3647],"./me-i18n-locale-ro.js":["Wvze",3647],"./me-i18n-locale-ru":["5Xva",3648],"./me-i18n-locale-ru.js":["5Xva",3648],"./me-i18n-locale-sk":["jZcU",3649],"./me-i18n-locale-sk.js":["jZcU",3649],"./me-i18n-locale-zh":["s1kf",3651],"./me-i18n-locale-zh-cn":["s2+q",3650],"./me-i18n-locale-zh-cn.js":["s2+q",3650],"./me-i18n-locale-zh.js":["s1kf",3651]}
...
Promise.all([i.e(1),i.e(2),i.e(3),i.e(9),i.e(4097)]).then(i.bind(null,"KWYq")).then(({default:e})=>{new e(t.options.mediaCommentId,t.media.src)})})
...
var m=[]
var p=false
for(var f=0,_=n.options.speeds.length;f<_;f++){var h=n.options.speeds[f]
if("string"===typeof h){m.push({name:h+n.options.speedChar,value:h})
h===n.options.defaultSpeed&&(p=true)}else{m.push(h)
h.value===n.options.defaultSpeed&&(p=true)}}p||m.push({name:n.options.defaultSpeed+n.options.speedChar,value:n.options.defaultSpeed})
m.sort((function(e,t){return parseFloat(t.value)-parseFloat(e.value)}))
var g=function(e){for(f=0,_=m.length;f<_;f++)if(m[f].value===e)return m[f].name}
...
a[r]?a[r].parts.push(u):i.push(a[r]={id:r,parts:[u]})}return i}function _(e,t){var i=s(e.insertInto)
...
i.insertBefore(t,o)}}function h(e){if(null===e.parentNode)return false
...
const o=function(){if(!a){e.cancelled&&s.a.isFunction(e.cancelled)&&e.cancelled.call(t)
...
s.a.ajaxJSON(e.url,"DELETE",a,i=>{e.success.call(t,i)},(i,a,o,n)=>{e.error&&s.a.isFunction(e.error)?e.error.call(t,i,a,o,n):s.a.ajaxJSON.unhandledXHRs.push(a)})}else{e.success||(e.success=function(){t.fadeOut("slow",()=>{t.remove()})})
e.success.call(t)}}
...
i=s()(e.message).dialog(s.a.extend({},{modal:true,close:o,buttons:[{text:n.t("#buttons.cancel","Cancel"),click(){s()(this).dialog("close")}},{text:n.t("#buttons.delete","Delete"),class:r,click(){a=true
s()(this).dialog("close")}}]},t))
return}a=confirm(e.message)}o()}
...
e.doc[0]==o[0]&&(n=true)}n||s.a._checkFragments.fragmentList.push({doc:o,fragment:""})
s()(window).bind("hashchange",s.a._checkFragments)
setTimeout(()=>{a&&a.length>0?o.triggerHandler("document_fragment_change",a):o&&o[0]&&o[0].location&&o[0].location.hash.length>0&&o.triggerHandler("document_fragment_change",o[0].location.hash)},500)}else this.triggerHandler("document_fragment_change",this[0].location.hash)
return this}
...
t.css({width:a+6,height:o+6,top:i.top-3,left:i.left-3,zIndex:n+1,position:"absolute",display:"block","-moz-border-radius":5,opacity:.8,border:"2px solid #870",backgroundColor:"#fd0"})
...
return this}
s.a.fn.fillWindowWithMe=function(e){const t=s.a.extend({minHeight:400},e),i=s()(this),a=s()("#wrapper"),o=s()("#main"),n=s()("#not_right_side"),r=s()(window),l=s()(this).add(t.alsoResize)
function d(){l.height(0)
const e=r.height()-(a.offset().top+a.outerHeight())+(o.height()-n.height()),d=Math.max(400,e)
l.height(d)
...
this.filter("input:text").each((function(){let t=e.minWidth||s()(this).width(),i="",a=s()(this),o=s()("<tester/>").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:a.css("fontSize"),fontFamily:a.css("fontFamily"),fontWeight:a.css("fontWeight"),letterSpacing:a.css("letterSpacing"),whiteSpace:"nowrap"}),n=function(){setTimeout(()=>{if(i===(i=a.val()))return
o.text(i)
const n=o.width(),r=n+e.comfortZone>=t?n+e.comfortZone:t,s=a.width(),l=r<s&&r>=t||r>t&&r<e.maxWidth
l&&a.width(r)})}
o.insertAfter(a)
...
//# sourceMappingURL=48-c-5500f17c4c.js.map
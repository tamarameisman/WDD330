...
a.handleKeyDown=function(e){if("toggle"===a.props.variant&&(e.keyCode===u.a.codes.enter||e.keyCode===u.a.codes.return)){a._input.click()
e.preventDefault()}}
...
return a}Object(i["a"])(t,[{key:"componentDidMount",value:function(){this._input.indeterminate=this.props.indeterminate}},{key:"componentDidUpdate",value:function(e){e.indeterminate!==this.props.indeterminate&&(this._input.indeterminate=this.props.indeterminate)}},{key:"focus",value:function(){this._input&&this._input.focus()}},{key:"renderFacade",value:function(){var e=this.props,n=e.size,t=e.disabled,a=e.variant,r=e.label,i=e.readOnly,o=e.indeterminate,c=e.labelPlacement
var l=this.state,s=l.hovered,h=l.focused
return"toggle"===a?d.a.createElement(O["a"],{disabled:t,size:n,hovered:s,focused:h,checked:this.checked,readOnly:i,labelPlacement:c},r):d.a.createElement(J["a"],{size:n,hovered:s,focused:h,checked:this.checked,indeterminate:o},r)}},{key:"render",value:function(){var e,n=this
var r=this.props,i=r.inline,o=r.disabled,c=r.readOnly,l=r.messages,s=r.value,h=r.onKeyDown,f=r.onFocus,u=r.onBlur,b=r.onMouseOver,y=r.onMouseOut,v=r.indeterminate
r.variant
var k=Object(S["a"])(this.props,t.propTypes)
var _=(e={},Object(a["a"])(e,M.root,true),Object(a["a"])(e,M.disabled,o),Object(a["a"])(e,M.inline,i),e)
return d.a.createElement("div",{className:m()(_),onMouseOver:Object(p["a"])(b,this.handleMouseOver),onMouseOut:Object(p["a"])(y,this.handleMouseOut)},d.a.createElement("input",Object.assign({},k,{id:this.id,value:s,type:"checkbox",ref:function(e){n._input=e},disabled:o||c,"aria-checked":v?"mixed":null,className:M.input,onChange:this.handleChange,onKeyDown:Object(p["a"])(h,this.handleKeyDown),onFocus:Object(p["a"])(f,this.handleFocus),onBlur:Object(p["a"])(u,this.handleBlur),checked:this.checked})),d.a.createElement("label",{htmlFor:this.id,className:M.control},this.renderFacade(),d.a.createElement(g["c"],{messages:l})))}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"checked",get:function(){return"undefined"===typeof this.props.checked?this.state.checked:this.props.checked}},{key:"focused",get:function(){return Object(k["a"])(this._input)}}])
t.displayName="Checkbox"
return t}(l["Component"]),C.propTypes={label:h.a.node.isRequired,id:h.a.string,value:h.a.oneOfType([h.a.string,h.a.number]),messages:h.a.arrayOf(g["d"].message),defaultChecked:h.a.bool,checked:Object(y["a"])(h.a.bool,"onChange","defaultChecked"),onChange:h.a.func,onKeyDown:h.a.func,onFocus:h.a.func,onBlur:h.a.func,onMouseOver:h.a.func,onMouseOut:h.a.func,disabled:h.a.bool,readOnly:h.a.bool,indeterminate:h.a.bool,size:h.a.oneOf(["small","medium","large"]),variant:h.a.oneOf(["simple","toggle"]),inline:h.a.bool,labelPlacement:h.a.oneOf(["top","start","end"])},C.defaultProps={size:"medium",variant:"simple",disabled:false,inline:false,indeterminate:false,readOnly:false,onChange:void 0,onKeyDown:void 0,onFocus:void 0,onBlur:void 0,onMouseOut:void 0,onMouseOver:void 0,checked:void 0,defaultChecked:void 0,messages:void 0,id:void 0,value:void 0,labelPlacement:"end"},B))||j)||j)},EQyN:function(e,n,t){"use strict"

(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[143],{G4i8:function(e,t,n){var r={"./__tests__/lti.resourceImported.test.js":["LFe7",4134],"./__tests__/lti.screenReaderAlert.test.js":["0Guc",4135],"./__tests__/requestFullWindowLaunch.test.js":["o6ta",4136],"./lti.enableScrollEvents.js":["HVU3",4195],"./lti.fetchWindowSize.js":["OANa",4196],"./lti.frameResize.js":["bSyB",4127],"./lti.removeUnloadMessage.js":["tjuu",4137],"./lti.resourceImported.js":["FC2N",4197],"./lti.screenReaderAlert.js":["YYEg",4198],"./lti.scrollToTop.js":["W/R1",4199],"./lti.setUnloadMessage.js":["6fDN",4138],"./lti.showModuleNavigation.js":["NSTA",4200],"./requestFullWindowLaunch.js":["8IHO",4201],"./toggleCourseNavigationMenu.js":["ECMy",3629,4202]}
function o(e){if(!n.o(r,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'")
t.code="MODULE_NOT_FOUND"
throw t}))
var t=r[e],o=t[0]
return Promise.all(t.slice(1).map(n.e)).then((function(){return n(o)}))}o.keys=function(){return Object.keys(r)}
o.id="G4i8"
e.exports=o},P6Tl:function(e,t,n){"use strict"
n.d(t,"a",(function(){return o}))
var r=n("hK1/")
function o(e){const t=r["a"].fromEvent(e,i)
if(t)return t.process()}async function i(){if(this.contentItems.length>0)return this.contentItems[0]}},QAiK:function(e,t,n){"use strict"
var r=n("ouhR")
var o=n.n(r)
var i=n("mX+G")
var a=n.n(i)
...
o=o||{}
var i,a,s,d="",_=n.helperMissing,l=this.escapeExpression,c="function"
d+='<div class="before_external_content_info_alert screenreader-only" tabindex="0">\n  <div class="ic-flash-info">\n    <div class="ic-flash__icon" aria-hidden="true">\n      <i class="icon-info"></i>\n    </div>\n    '+l((a=n.t||t&&t.t,s={hash:{scope:"external_tools.external_content_return_view"},data:o},a?a.call(t,"The following content is partner provided",s):_.call(t,"t","The following content is partner provided",s)))+'\n  </div>\n</div>\n<iframe\n  tabindex="0"\n  class="tool_launch"\n  src="'
if(a=n.launch_url)i=a.call(t,{hash:{},data:o})
else{a=t&&t.launch_url
i=typeof a===c?a.call(t,{hash:{},data:o}):a}d+=l(i)+'"\n  title="'+l((a=n.t||t&&t.t,s={hash:{i18n_inferred_key:true},data:o},a?a.call(t,"tool_content_2924d18f","Tool content",s):_.call(t,"t","tool_content_2924d18f","Tool content",s)))+'"\n  allow="'
if(a=n.allowances)i=a.call(t,{hash:{},data:o})
else{a=t&&t.allowances
i=typeof a===c?a.call(t,{hash:{},data:o}):a}d+=l(i)+'"\n  data-lti-launch="true"\n>\n</iframe>\n<div class="after_external_content_info_alert screenreader-only" tabindex="0">\n  <div class="ic-flash-info">\n    <div class="ic-flash__icon" aria-hidden="true">\n      <i class="icon-info"></i>\n    </div>\n    '+l((a=n.t||t&&t.t,s={hash:{scope:"external_tools.external_content_return_view"},data:o},a?a.call(t,"The preceding content is partner provided",s):_.call(t,"t","The preceding content is partner provided",s)))+"\n  </div>\n</div>\n"
return d}))
var g=h[u]
var f=n("dDTa")
var v=function(e,t){return function(){return e.apply(t,arguments)}},m=function(e,t){for(var n in t)w.call(t,n)&&(e[n]=t[n])
...
return this.removeDialog()}
return t}(a.a.View)},fhP7:function(e,t,n){"use strict"
n.d(t,"k",(function(){return r}))
n.d(t,"e",(function(){return o}))
n.d(t,"f",(function(){return i}))
n.d(t,"g",(function(){return a}))
n.d(t,"h",(function(){return s}))
n.d(t,"l",(function(){return d}))
n.d(t,"i",(function(){return _}))
n.d(t,"b",(function(){return l}))
n.d(t,"j",(function(){return c}))
...
const d=ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN
...
const u={ariaControlTemplate:e=>e+"-mention-popup",activeDescendant:(e,t)=>`${e}-mention-popup-item-${t}`}},"hK1/":function(e,t,n){"use strict"
...
class d extends s{constructor(e,t,n){super(e,t,n)
this.url=`${t}?${this.ltiEndpointParams(e.url,e.lookup_uuid)}`}ltiEndpointParams(e,t){let n="display=borderless"
null!==t&&void 0!==t&&(n+="&resource_link_lookup_uuid="+t)
return`${n}&url=${encodeURIComponent(e)}`}toHtmlString(){if(this.iframe){this.iframe.src=this.safeUrl()
return this.iframeTag()}return this.anchorTag(this.linkBody())}}class _ extends a{constructor(e){super(e)
this.type=_.type}get properties(){return Object.freeze(["url","title","thumbnail","text","width","height"])}toHtmlString(){if(this.thumbnail)return this.anchorTag(this.linkThumbnail())
return this.imageTag(this.safeUrl(),this.width,this.height)}}_.type="image"
class l extends a{constructor(e){super(e)
this.type=l.type}get properties(){return Object.freeze(["html","title","text"])}toHtmlString(){return this.html}}l.type="html"
var c=n("jFoo")
class p{constructor(e,t,n,r,o){this.contentItems=e
this.messages=t
this.logs=n
this.ltiEndpoint=r
this.processHandler=o
this.showMessages()
this.showLogs()}get loggingEnabled(){return ENV&&ENV.DEEP_LINKING_LOGGING}get typeMap(){return{link:s,ltiResourceLink:d,image:_,html:l}}static fromEvent(e,t){const n=e.data,r=n.content_items,o=n.msg,i=n.log,a=n.errormsg,s=n.errorlog,d=n.ltiEndpoint,_=n.messageType
if("LtiDeepLinkingResponse"!==_)return
return new this(r,{msg:o,errormsg:a},{log:i,errorlog:s},d,t)}process(){null!==c["a"]&&void 0!==c["a"]&&c["a"].fullWindowProxy&&c["a"].fullWindowProxy.close()
...
this.logs.log&&console.log(this.logs.log)}}}},jFoo:function(e,t,n){"use strict"
...
const d="bad_request"
const _=({targetWindow:e,origin:t,subject:n,message_id:r})=>{const _=(i={})=>{const a={subject:n+".response"}
r&&(a.message_id=r)
e?e.postMessage(Object(o["a"])(Object(o["a"])({},a),i),t):console.error("Error sending response postMessage: target window does not exist")}
const l=()=>{_({})}
const c=(e,t)=>{const n={code:e}
t&&(n.message=t)
_({error:n})}
const p=e=>{c(i,e)}
const h=e=>{c(d,e)}
const u=()=>{c(s)}
const g=()=>{c(a)}
return{sendResponse:_,sendSuccess:l,sendError:c,sendGenericError:p,sendBadRequestError:h,sendWrongOriginError:u,sendUnsupportedSubjectError:g}}
var l=_
const c={}
const p=["lti.enableScrollEvents","lti.fetchWindowSize","lti.frameResize","lti.removeUnloadMessage","lti.resourceImported","lti.screenReaderAlert","lti.scrollToTop","lti.setUnloadMessage","lti.showModuleNavigation","requestFullWindowLaunch","toggleCourseNavigationMenu"]
const h=["A2ExternalContentReady","LtiDeepLinkingResponse",r["i"],r["b"],r["j"]]
async function u(e,t=false){if(e.data.source&&e.data.source.includes("react-devtools"))return false
let r
try{r="string"===typeof e.data?JSON.parse(e.data):e.data}catch(e){return false}const o=r.subject||r.messageType
const i=l({targetWindow:e.source,origin:e.origin,subject:o,message_id:r.message_id})
if(h.includes(o))return false
if(!p.includes(o)){t&&i.sendUnsupportedSubjectError()
return false}try{const a=await n("G4i8")(`./${o}.js`)
const s=a.default({message:r,event:e,responseMessages:i})
!s&&t&&i.sendSuccess()
return true}catch(e){console.error(`Error loading or executing message handler for "${o}": ${e}`)
t&&i.sendGenericError(e.message)
return false}}function g(){var e,t
const n=null===(e=ENV)||void 0===e||null===(t=e.FEATURES)||void 0===t?void 0:t.lti_platform_storage
window.addEventListener("message",e=>{""!==e.data&&u(e,n)})}},plYi:function(e,t,n){"use strict"
var r=n("HGxv")
...
//# sourceMappingURL=143-c-a0c0e5da67.js.map